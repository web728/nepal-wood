      ...
      <section className="bg-slate-50/50 py-12 lg:py-16">
        <Container>
          ...
          <div className="mb-8 flex flex-col items-start justify-between gap-4 border-b border-brand-brown/10 pb-6 sm:flex-row sm:items-center">
            ...
            <div className="flex items-center gap-2 rounded-2xl border border-brand-brown/10 bg-white px-4 py-2 text-xs font-semibold text-brand-brown/80 shadow-xs">
              <Images className="h-4 w-4 text-brand-amber" />
              <span>{galleryImages.length} High-Resolution Photos</span>
            </div>
          </div>
